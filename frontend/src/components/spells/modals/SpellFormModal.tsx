...
export function SpellFormModal({
  open,
  onClose,
  editing,
}: SpellFormModalProps) {
  ...
  function set<K extends keyof CreateSpellDto>(
    key: K,
  ...
  function setSpellTypeKind(kind: SpellType["kind"]) {
    if (kind === "attack")
      set("spellType", { kind: "attack", attackType: "Ranged Spell Attack" });
    else if (kind === "save")
      set("spellType", { kind: "save", saveAbility: "Dexterity" });
    else set("spellType", { kind: "utility" });
  }

  // ── components helpers ─────────────────────────────────────────────────────
  function setComp<K extends keyof SpellComponents>(
    key: K,
  ...
  function addDie() {
    ...
    set("outputType", {
      ...out,
      dice: [...out.dice, { count: 1, die: "d6", type: "Fire" }],
    });
  }
  ...
  function removeUpcast(i: number) {
    ...
    set("outputType", {
      ...out,
      upcast: arr.length ? { dice: arr } : undefined,
    });
  }
  ...
  function setProjectileBase(n: number) {
    ...
    set("outputType", {
      ...out,
      projectiles: { ...out.projectiles, baseCount: n },
    });
  }
  function toggleProjectileUpcast(enabled: boolean) {
    ...
    set("outputType", {
      ...
      projectiles: enabled
        ? {
            ...out.projectiles,
            upcast: { count: 1, everyNLevels: 1, aboveLevel: spellLevel },
          }
  ...
  function addScalingTier() {
    ...
    set("outputType", {
      ...out,
      scaling: [...out.scaling, { characterLevel: 5, diceCount: 2 }],
    });
  }
  ...
  function removeScalingTier(i: number) {
    ...
    set("outputType", {
      ...out,
      scaling: out.scaling.filter((_, j) => j !== i),
    });
  }
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="mt-3">
              ...
              <select
                ...
                onChange={(e) =>
                  set("spellType", {
                    kind: "save",
                    saveAbility: e.target.value as any,
                  })
                }
              >
                {ABILITIES.map((a) => (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    set("spellType", {
                      ...st,
                      attackType: e.target.value as any,
                    })
                  }
                >
                  {ATTACK_TYPES.map((a) => (
                ...
                <input
                  ...
                  onChange={(e) =>
                    set("spellType", {
                      ...st,
                      critRange:
                        +e.target.value === 20 ? undefined : +e.target.value,
                    })
                  }
                />
              </div>
        ...
        <div>
          ...
          <div className="mb-5 grid grid-cols-3 gap-4">
            {(
              ["cantrip", "leveled", "utility"] as OutputTypeShape["kind"][]
            ).map((k) => (
              <CheckboxInput
                key={k}
                element={k}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateCantripDie({ die: e.target.value as any })
                    }
                  >
                    {DIE_TYPES.map((d) => (
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateCantripDie({ type: e.target.value as any })
                    }
                  >
                    {OUTPUT_TYPES.map((t) => (
                ...
                <div className="flex items-end pb-1">
                  <label className="flex cursor-pointer items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        updateCantripDie({ addCastingMod: e.target.checked })
                      }
                    />
                    <span className="text-dim text-sm">+ Casting Mod</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                {cantripScaling.map((tier, i) => (
                  <div key={i} className="mb-1.5 flex gap-2">
                    ...
                    <button
                      type="button"
                      className="mb-0.5 flex h-9 w-8 items-center justify-center self-end text-red-400 hover:text-red-300"
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        value={d.count}
                        onChange={(e) =>
                          updateDie(i, { count: +e.target.value })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <select
                        ...
                        value={d.die}
                        onChange={(e) =>
                          updateDie(i, { die: e.target.value as any })
                        }
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        value={d.type}
                        onChange={(e) =>
                          updateDie(i, { type: e.target.value as any })
                        }
                      >
                        {OUTPUT_TYPES.map((t) => (
                          <option key={t}>{t}</option>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateDie(i, {
                            flatBonus: +e.target.value || undefined,
                          })
                        }
                      />
                    </div>
                    <label className="flex cursor-pointer flex-col items-center gap-1">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateDie(i, { addCastingMod: e.target.checked })
                        }
                      />
                    </label>
                    <button
                      type="button"
                      className="self-end pb-1.5 text-center text-red-400 hover:text-red-300"
                      onClick={() => removeDie(i)}
                    >
                      ✕
                    </button>
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        value={u.count}
                        onChange={(e) =>
                          updateUpcast(i, { count: +e.target.value })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <select
                        ...
                        value={u.die}
                        onChange={(e) =>
                          updateUpcast(i, { die: e.target.value as any })
                        }
                      >
                        <option value="d0">d0 (none)</option>
                        {DIE_TYPES.map((t) => (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateUpcast(i, { everyNLevels: +e.target.value })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        value={u.aboveLevel}
                        onChange={(e) =>
                          updateUpcast(i, { aboveLevel: +e.target.value })
                        }
                      />
                    </div>
                    <div>
                    ...
                    <div className="flex items-end gap-2">
                      <div className="flex-1">
                        ...
                        <select
                          ...
                          value={u.type}
                          onChange={(e) =>
                            updateUpcast(i, { type: e.target.value as any })
                          }
                        >
                          {OUTPUT_TYPES.map((t) => (
                            <option key={t}>{t}</option>
                      ...
                      <button
                        type="button"
                        className="w-6 pb-1 text-red-400"
                      ...
                      <div className="flex items-end pb-1">
                        <label className="flex cursor-pointer items-center gap-2">
                          <input
                            ...
                            onChange={(e) =>
                              toggleProjectileUpcast(e.target.checked)
                            }
                          />
                          <span className="text-dim text-sm">
                            Upcast adds projectiles
                          </span>
                        </label>
                      </div>
                    </div>
